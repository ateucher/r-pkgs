...
....
#> ✔ Creating '/tmp/Rtmp5444Bb/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp5444Bb/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|476441c8f7… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5444Bb/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5444Bb/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp5444Bb/regexcite/README.Rmd'
----
