...
....
#> ✔ Creating '/tmp/Rtmp5xgdZ8/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp5xgdZ8/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|d6d32ad02e… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5xgdZ8/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5xgdZ8/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp5xgdZ8/regexcite/README.Rmd'
----
