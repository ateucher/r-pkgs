...
....
#> ✔ Creating '/tmp/RtmplKbKVa/regexcite/'
#> ✔ Setting active project to '/tmp/RtmplKbKVa/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|455e2feb60… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmplKbKVa/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmplKbKVa/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmplKbKVa/regexcite/README.Rmd'
----
