...
....
#> ✔ Creating '/tmp/RtmpActrGq/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpActrGq/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|95bdf0a3de… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpActrGq/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpActrGq/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpActrGq/regexcite/README.Rmd'
----
