...
....
#> ✔ Creating '/tmp/Rtmpt7Ffxu/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpt7Ffxu/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|3eb8d3a86a… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpt7Ffxu/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpt7Ffxu/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpt7Ffxu/regexcite/README.Rmd'
----
