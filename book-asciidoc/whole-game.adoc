...
....
#> ✔ Creating '/tmp/Rtmplc1Aws/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmplc1Aws/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|9bf3fe1bb2… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmplc1Aws/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmplc1Aws/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmplc1Aws/regexcite/README.Rmd'
----
