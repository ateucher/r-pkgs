...
....
#> ✔ Creating '/tmp/Rtmp8A3ZKk/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp8A3ZKk/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|3998e54ca1… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp8A3ZKk/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp8A3ZKk/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp8A3ZKk/regexcite/README.Rmd'
----
