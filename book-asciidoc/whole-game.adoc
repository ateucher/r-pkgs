...
....
#> ✔ Creating '/tmp/RtmpypEdMp/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpypEdMp/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|b34a239fb9… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpypEdMp/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpypEdMp/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpypEdMp/regexcite/README.Rmd'
----
