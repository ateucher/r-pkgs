...
....
#> ✔ Creating '/tmp/Rtmp3cBIzt/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp3cBIzt/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|069bb7d090… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp3cBIzt/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp3cBIzt/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp3cBIzt/regexcite/README.Rmd'
----
