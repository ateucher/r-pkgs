...
....
#> ✔ Creating '/tmp/RtmpHnNBhF/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpHnNBhF/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|4f75ec271f… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpHnNBhF/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpHnNBhF/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpHnNBhF/regexcite/README.Rmd'
----
