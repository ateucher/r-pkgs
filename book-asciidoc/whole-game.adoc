...
....
#> ✔ Creating '/tmp/RtmpkM6Bdi/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpkM6Bdi/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|98105d24d3… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpkM6Bdi/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpkM6Bdi/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpkM6Bdi/regexcite/README.Rmd'
----
