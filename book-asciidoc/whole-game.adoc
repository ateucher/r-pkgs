...
....
#> ✔ Creating '/tmp/RtmpbLE3Rc/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpbLE3Rc/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|9e92f1b5a5… |ateucher ateucher@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpbLE3Rc/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpbLE3Rc/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpbLE3Rc/regexcite/README.Rmd'
----
